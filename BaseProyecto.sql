...
-- -----------------------------------------------------
-- Table `proyecto`.`gradoAcademico`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `proyecto`.`gradoAcademico` (
...
CREATE TABLE IF NOT EXISTS `proyecto`.`anteproyecto` (
  ...
  INDEX `fk_anteproyecto_director_idx` (`iddirector` ASC) VISIBLE,
  INDEX `fk_anteproyecto_coDirector_idx` (`idcoDirector` ASC) VISIBLE,
  INDEX `fk_anteproyecto_LGAC_idx` (`idLGAC` ASC) VISIBLE,
  CONSTRAINT `fk_anteproyecto_director`
    FOREIGN KEY (`iddirector`)
    REFERENCES `proyecto`.`usuario` (`idusuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_anteproyecto_coDirector`
...
CREATE TABLE IF NOT EXISTS `proyecto`.`usuario` (
  ...
  INDEX `fk_usuario_gradoAcademico_idx` (`gradoAcademico` ASC) VISIBLE,
  INDEX `fk_usuario_anteproyecto_idx` (`idanteproyecto` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_usuario_rolSistema`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_gradoAcademico`
    FOREIGN KEY (`gradoAcademico`)
    REFERENCES `proyecto`.`gradoAcademico` (`idgradoAcademico`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_usuario_anteproyecto`
